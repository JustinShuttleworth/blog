...
function Post({ date, image, title, content, authors, readingTime, tags }) {
            ...
            <div className={classes.sidebar}>
              <div className={classes.sidebarPadding}>
                <div className={classes.sidebarBlock}>
                  ...
                  <Typography variant={'caption'}>{date.substring(0, 10)}</Typography>
                </div>

                <div className={classes.sidebarBlock}>
                  <Typography variant={'h6'}>Author</Typography>
                  <Typography variant={'caption'}>{authors.map(author => author.fields.name)}</Typography>
                </div>

                {/*<div className={classes.sidebarBlock}>*/}
                {/*  <Typography variant={'h6'}>Reading Time</Typography>*/}
                {/*  <Typography variant={'caption'}>{readingTime} Minutes</Typography>*/}
                {/*</div>*/}
